...
import bgu.spl.mics.*;
import bgu.spl.mics.Tester.Test;
    ...
    public void runTestsFromFile() {
        ...
        try {
            ...
            for (int i = 0; i < currentTests.length; i++) {
                ...
                long shieldDeactivationTestValue = (diaryInstance.getR2D2Deactivated() - startingTimeOfTest);
                System.out.println("\r\n-----------------------------------");
                ...
                System.out.println("\r\n");
                AtomicInteger testAtomic = new AtomicInteger(0);
                diaryInstance.setTotalAttacks(testAtomic);
            }
            System.out.println("\r\n-----------------");
    ...
    */
    ...
    public void runLogicalTests() {
        try {
            ...
            MessageBusImpl messageInstance = MessageBusImpl.GetMessageBusInstance();
